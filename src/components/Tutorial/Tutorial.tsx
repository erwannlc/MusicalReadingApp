...
// --> btn langue & wordings complet / avec useContext

// --> gestion post-correction : 
//// bouton pour reseter les données, revenir à l'écran par défaut ?
//// créer un nouveau message avec dernier score par ex. 

// --> progressBar sur tuto pour savoir où on en est  
// & gestion fin de chapitre tuto...

// --> réajuster les (data) niveaux et tempo (plus progressif)

// --> onMouseEnter onMouseLeave sur defaultMessage p...

// --> !!! dernière note affichée on play

// --> tooltip sur les notes de piano (nom de la note)

// --> mettre en évidence la dernière note affichée (clignotement, couleur...)

// --> animer l'affichage de la table-answers 

// --> transition fade-out pour le tuto dialog 

// --> tester useContext pour les nodes ?

// --> tuto sur mobile 

// --> afficher les soupirs au lieu de note vide dans bothClefs ==> dans createStaves

// --> Mobile : afficher la note fausse en cliquant sur la note dans Modal / correction

// --> afficher image de : note référence (genre Do) sur une portée, ou lien vers un site ext "https://www.mypianopop.com/cle-fa/", sur un click "help me"
// --> Modal tutoriel au premier chargement (local storage). 
// --> Demander le niveau du joueur en checkbox ? (découverte, intermédiaire, avancé) et pré-configuer les options en fonction
// --> Garder les réglages en mémoire (local storage)
// --> Mode "debutant/decouverte" avec click pour passer à la note suivante
// --> score évolué (tient de la difficulté, tempo etc.) et gestion des high-scores

// --> API voicespeech
//// Finir test API
//// Implémenter API (nouvelle branch git ?) 
//// bouton micro

////// FAIT -----------------------
////// refactor nodes queries en hooks (ou props)
////// mediaqueries pour mobile
////// affichage du vexScore (afficher que en Game et while correction), (sur Mobile, max-height 670px ?)
////// bouton switch Options couleur if isActive
////// Knob buttons event.preventDefault()
////// "btn quitter" (taille)
////// progressBar on play plus discrète
////// gérer le pb si tutoAnswer est incomplet
///// tooltips sur tous les boutons, + cursor: pointer
////// bug en refaisant une tuto play après revenir au sommaire
////// media queries mobile (progressbar)
///// steps contents : niveau 0 1
///// sendBackToStep // backToZero... gotToStep
///// affichage des notes précédentes dans le tuto play 
//// animation des pads disparait while playing
///// progressBar on play 
///// meilleur effet d'anim sur PadsNotes et Clefs...
//// remettre les options ok si le piano est ouvert plutôt que les Pads, clefs, tempo
//// fin du tuto : pb de listener mouseup et touchend dans Piano.tsx 
