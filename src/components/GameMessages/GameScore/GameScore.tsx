...
const GameScore: FC<Props> = ({
  ...
  if (scoreNumber >= 0) {
    const scoreDashOffset = scoreNumber === gameLength
      ? 0
      : 320 * +((gameLength - scoreNumber) / gameLength).toFixed(1);
        ...
        <div className="score-container__progressbars">
          <div className="progressbar">
            <svg className="progressbar__svg">
              ...
              r="50"
              id="scoreCircle"
              className={className.scoreCircle}> </circle>
              {/* <circle
              cx="80"
              cy="80"
              r="70"
              id="scoreCircle"
              className="progressbar__svg-circle shadow-node"> </circle> */}
            </svg>
